...
-- Job Tests
INSERT INTO `job`(job, type_exclusive, type_id)
...
-- Character Tests
INSERT INTO `Character` (name, type_id, group_id, gender, city_id, photo_id)
VALUES ('Applejack' (SELECT id FROM `Type` WHERE name = 'Earth Pony'), (SELECT id FROM `Group` WHERE name = 'Mane Six'), 'F' (SELECT id FROM `City` WHERE name = 'Ponyville'), photo test?);

INSERT INTO `Character` (name, type_id, group_id, gender, city_id, photo_id)
VALUES ('Twilight Sparkle' (SELECT id FROM `Type` WHERE name = 'Unicorn'), (SELECT id FROM `Group` WHERE name = 'Mane Six'), 'F' (SELECT id FROM `City` WHERE name = 'Canterlot'), photo test?);

INSERT INTO `Character` (name, type_id, group_id, gender, city_id, photo_id)
VALUES ('Rainbow Dash' (SELECT id FROM `Type` WHERE name = 'Pegasus'), (SELECT id FROM `Group` WHERE name = 'Mane Six'), 'F' (SELECT id FROM `City` WHERE name = 'Cloudsdale'), photo test?);
